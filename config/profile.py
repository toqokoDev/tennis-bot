...
cities_data = {
    ...
    "🇧🇾 Беларусь": [
        ...
        "Брест", "Барановичи", "Бобруйск", "Орша", "Пинск"
    ],
    "🇰🇿 Казахстан": [
    ...
    "🇬🇪 Грузия": [
        ...
        "Гори", "Поти", "Телави", "Ахалцихе", "Марнеули"
    ],
    "🇦🇲 Армения": [
        "Ереван", "Гюмри", "Ванадзор", "Вагаршапат (Эчмиадзин)", "Абовян",
        "Храздан", "Капан", "Арарат", "Армавир", "Гавар"
    ],
    "🇦🇪 ОАЭ": [
        "Дубай", "Абу-Даби", "Шарджа", "Аль-Айн", "Аджман",
        "Рас-эль-Хайма", "Фуджейра", "Умм-аль-Кувейн", "Дибба-аль-Фуджейра", "Хор-Факкан"
    ]
}
